...
--更新可以使用短信认证
update  db.oauth2_registered_client set authorization_grant_types ='refresh_token,client_credentials,authorization_code,urn:ietf:params:oauth:grant-type:sms_code'
