...
//                            }})
    ...
    public CorsFilter corsFilter() {
        ...
        list.add("http://rookie-authorization.vue.com:5173");
...
//        configuration.addAllowedOrigin("http://127.0.0.1:5173");
    ...
    public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate, PasswordEncoder passwordEncoder) {
        RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://rookie-authorization.client.com:8000/login/oauth2/code/messaging-client-oidc")
...
//        return AuthorizationServerSettings.builder().build();
        ...
        http:
//rookie-authorization.server.com:8080
...
//                .issuer("http://192.168.120.33:8080")
                .issuer("http://rookie-authorization.server.com:8080")
                .build();
    }
