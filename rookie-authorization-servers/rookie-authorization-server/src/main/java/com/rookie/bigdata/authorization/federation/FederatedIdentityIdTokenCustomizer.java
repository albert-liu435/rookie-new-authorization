package com.rookie.bigdata.authorization.federation;
...
/**
 * @Class FederatedIdentityIdTokenCustomizer
 * @Description An {@link OAuth2TokenCustomizer} to map claims from a federated identity to
