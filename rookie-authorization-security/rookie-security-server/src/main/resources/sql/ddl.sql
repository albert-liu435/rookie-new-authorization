...
INSERT INTO demo_security.`user` (name,password,`role`) VALUES
...
INSERT INTO demo_security.role_user (user_id,role_id) VALUES
                                                          (1,1),
                                                          (2,2);
...
INSERT INTO demo_security.`role` (name) VALUES
                                            ('ROLE_ADMIN'),
                                            ('ROLE_USER');
...
INSERT INTO demo_security.menu_role (role_id,menu_id) VALUES
                                                          (1,1),
                                                          (2,2);
...
INSERT INTO demo_security.menu (request_url) VALUES
                                                 ('/admin/info'),
                                                 ('/user/*');
